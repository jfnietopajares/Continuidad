...
public class PantallaPrincipal
    ...
    private static final Logger LOGGER = LogManager.getLogger(PantallaPrincipal.class);

    private final VerticalLayout contenedorPantalla = new VerticalLayout();
    private final HorizontalLayout contenedorMenu = new HorizontalLayout();
    private final HorizontalLayout contenedorFormularios = new HorizontalLayout();
    ...
    public PantallaPrincipal() {
        ...
        this.add(contenedorPantalla);
        contenedorPantalla.setAlignItems(FlexComponent.Alignment.CENTER);
    ...
    public void domuestraMenu() {
        contenedorPantalla.removeAll();
        contenedorPantalla.add(contenedorMenu);
        contenedorPantalla.add(contenedorFormularios);
    ...
    public void doLogin() {
        ...
        contenedorPantalla.add(componentLogin);
    }

    private LoginI18n createEspanolI18n() {
        final LoginI18n i18n = LoginI18n.createDefault();
        i18n.setHeader(new LoginI18n.Header());
        i18n.getHeader().setTitle(".... Complejo Asistencial de Ávila");
