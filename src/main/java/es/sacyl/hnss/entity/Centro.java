...
public class Centro {
    ...
    public final static int TIPO_CENTRO_CS = 2;

    public final static int TIPO_CENTRO_CL = 6;

    public final static int AREA_SALUD_AVILA = 17;
    ...
    public String getDescripcionCorta(int ancho) {
        if (descripcion != null) {
            if (descripcion.contains("C.S.")) {
                descripcion = descripcion.substring(4, descripcion.length());
            }
