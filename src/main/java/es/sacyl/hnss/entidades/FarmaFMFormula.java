 ...
 * @author JuanNieto
 */
public class FarmaFMFormula {

    private Integer numero;
    private String nombre;
    private FarmaFMFormulaTipo tipo;
    private String esteril;
    private FarmaFMForma forma;
    private FarmaFMViasAdm via;
    ...
    private FarmaFMFormulaAutoriza p_autorizado;
    ...
    public FarmaFMFormulaTipo getTipo() {
        return tipo;
    }

    public void setTipo(FarmaFMFormulaTipo tipo) {
        this.tipo = tipo;
    }
    ...
    public FarmaFMForma getForma() {
        return forma;
    }

    public void setForma(FarmaFMForma forma) {
        this.forma = forma;
    }

    public FarmaFMViasAdm getVia() {
        return via;
    }

    public void setVia(FarmaFMViasAdm via) {
        this.via = via;
    }
    ...
    public FarmaFMFormulaAutoriza getP_autorizado() {
        return p_autorizado;
    }

    public void setP_autorizado(FarmaFMFormulaAutoriza p_autorizado) {
