...
@PageTitle("Complejo Asistencial de Ávila")
@BodySize(height = "100vh", width = "100vw")
@Meta(name = "author", content = "Juan")

@Route
@PWA(name = "continuidad", shortName = "continuidad")
@Theme(value = Lumo.class)
public class MainView extends VerticalLayout {

    private static final Logger LOGGER = LogManager.getLogger(MainView.class);

    private VerticalLayout contenedorPantalla = new VerticalLayout();
    ...
    public MainView() {
        ...
        contenedorPantalla.setAlignItems(Alignment.CENTER);
